          ...
          {FOUNDERS.map((founder, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 16, marginTop: 24 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--text-muted)" style={{ cursor: "pointer" }}>
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--text-muted)" style={{ cursor: "pointer" }}>
                  ...
                  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="none" stroke="var(--text-muted)" strokeWidth="2" />
                  <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="var(--text-muted)" strokeWidth="2" strokeLinecap="round" />
                </svg>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--text-muted)" style={{ cursor: "pointer" }}>
